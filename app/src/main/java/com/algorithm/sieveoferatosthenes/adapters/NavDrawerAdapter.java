package com.algorithm.sieveoferatosthenes.adapters;
...
public class NavDrawerAdapter extends RecyclerView.Adapter<NavDrawerAdapter.ViewHolder> {
     ...
     *                 we inflate header.xml and if this is call to for the navigation list view, we inflate the nav_bar_row.xml
     * @return
     */
    @Override
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView,int ViewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                textView = (TextView) itemView.findViewById(R.id.rowText); // Creating TextView object with the id of textView from nav_bar_row.xml
                imageView = (ImageView) itemView.findViewById(R.id.rowIcon);// Creating ImageView object with the id of ImageView from nav_bar_row.xml
    ...
    public NavDrawerAdapter(List<DrawerItem> dataList, Context context, String Name, int Profile){
    // MyAdapter Constructor with titles and icons parameter
    // titles, icons, name, profile pic are passed from the main activity
